                ...
                <Container className=' max-w-1170'>
                    <div className=' pt-yellow-box box_translate d-flex justify-content-center '>
                        ...
                        <Row className=' position-relative flex-column-reverse flex-lg-row yellow-box w-100  '>
                            <div className="col-12 mt-3 mt-md-5 mt-lg-0 justify-content-center justify-content-lg-start   col-lg-6 d-flex ">
                            ...
                            <div className="col-12  justify-content-center col-lg-6 d-flex justify-content-lg-end">
