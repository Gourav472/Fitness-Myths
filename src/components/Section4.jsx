            ...
            <section className=' section-4-bg-image '>
                <Container className=' max-w-1140'>
                    <Row className=' flex-column-reverse  flex-lg-row section4-py'>
                        <div className="col-12 mt-5  mt-lg-0 col-lg-8 d-flex justify-content-center justify-content-lg-start  align-items-lg-center" data-aos="fade-up-right">
                        ...
                        <div className="col-12    d-flex justify-content-center   col-lg-4" data-aos="fade-up-left">
